...
MODEL_PATH = "7daywindow_1dayprediction_best_model.pth"
BATCH_SIZE = 1000
TIME_STEPS = 7  # Match training window
OFFSET = 1

#### need to change data path too
preprocessed_dataset = "/s/bach/b/class/cs535/cs535a/data/preprocessed_7day/"
...
def evaluate(rank, world_size):
    ...
    if rank == 0:
        ...
        with open("CNN_evaluation_log_7Day.txt", "a") as f:
